    ...
    <div class="slide-1 home-slider">
        <div>
            <div class="home  text-center">
                <img src="<?php echo base_url();?>assets/images/home-banner/1.jpg" alt="" class="bg-img blur-up lazyload">
                <div class="container">
                    <div class="row">
                        <div class="col">
        ...
        <div>
            <div class="home text-center">
                <img src="<?php echo base_url();?>assets/images/home-banner/2.jpg" alt="" class="bg-img blur-up lazyload">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="slider-contain">
...
<section class="pb-0 ratio2_1">
    <div class="container">
        <div class="row partition2">
            <div class="col-md-6">
                <a href="<?php echo base_url();?>customer/discount">
                    <div class="collection-banner p-right text-center">
                        <div class="img-part">
                            <img src="<?php echo base_url();?>assets/images/sub-banner1.jpg" class="img-fluid blur-up lazyload bg-img"
                                alt="">
                        </div>
            ...
            <div class="col-md-6">
                <a href="<?php echo base_url();?>customer/offer">
                    <div class="collection-banner p-right text-center">
                        <div class="img-part">
                            <img src="<?php echo base_url();?>assets/images/sub-banner2.jpg" class="img-fluid blur-up lazyload bg-img"
                                alt="">
                        </div>
                        <div class="contain-banner">
                            <div>
...
<section class="p-4">
    <div class="full-banner parallax text-center p-left">
        <img src="<?php echo base_url();?>assets/images/parallax/1.jpg" alt="" class="bg-img blur-up lazyload">
        <div class="container">
            <div class="row">
                <div class="col">
...
<div class="p-4">
    ...
    <section class="pb-5 instagram ratio_square">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 p-0">
                    <h2 class="title-borderless"># RESELLER-HUB</h2>
                    <div class="slide-7 no-arrow slick-instagram">
                        ...
                        ?>
                        <div>
                            <a href="<?php echo base_url()."category/".$row->c_id;?>">
                                <div class="instagram-box"> <img src="<?php echo base_url();?>assets/images/slider/grocery.png" class="bg-img"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-check-circle-o" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        </div>
                        <div>
                            <a href="<?php echo base_url()."category/".$row->c_id;?>">
                                <div class="instagram-box"> <img src="<?php echo base_url();?>assets/images/slider/shirt.png" class="bg-img"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-check-circle-o" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="<?php echo base_url()."category/".$row->c_id;?>">
                                <div class="instagram-box"> <img src="<?php echo base_url();?>assets/images/slider/responsive.png" class="bg-img"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-check-circle-o" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="<?php echo base_url()."category/".$row->c_id;?>">
                                <div class="instagram-box"> <img src="<?php echo base_url();?>assets/images/slider/smartphone.png" class="bg-img"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-check-circle-o" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="<?php echo base_url()."category/".$row->c_id;?>">
                                <div class="instagram-box"> <img src="<?php echo base_url();?>assets/images/slider/appliance.png" class="bg-img"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-check-circle-o" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="<?php echo base_url()."category/".$row->c_id;?>">
                                <div class="instagram-box"> <img src="<?php echo base_url();?>assets/images/slider/furniture.png" class="bg-img"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-check-circle-o" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="<?php echo base_url()."category/".$row->c_id;?>">
                                <div class="instagram-box"> <img src="<?php echo base_url();?>assets/images/slider/cosmetics.png" class="bg-img"
                                        alt="Avatar" style="width:100%">
